...
import {
  Container, Table, Badge, Spinner, Alert, Card, Button
    ...
    <Container className="mt-5 mb-5">
      <Card className="shadow-sm border-0">
        <Card.Header className="bg-primary text-white py-3">
          <h4 className="mb-0 fw-bold text-center">LỊCH SỬ ĐẶT PHÒNG CỦA TÔI</h4>
        </Card.Header>
        <Card.Body>
                  ...
                  <tr key={r.id}>
                    ...
                    <td className="text-center">
                      <Button
                        ...
                        size="sm"
                        onClick={() => navigate(`/reservation-detail/${r.id}`)}
                      >
                        Xem chi tiết
                      </Button>
                    </td>
